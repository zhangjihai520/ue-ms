...
var tMapKey = {
	...
	gould : 'c1eb5436111397abaaf6572487aa7fa6'
}
//百度
var baiduMap ={
	show : function(){
	    ...
	    var clickEventListener = map.on('click', function(e) {
			...
			geocoder.getAddress(lnglatXY, function(status, result) {
				...
				if(status === 'complete' && result.info === 'OK') {
					...
					var src = result.regeocode.addressComponent;
					var city = result.regeocode.formattedAddress;
					var township =src.township;//街道
					var street =src.street;//路
					var streetNumber =src.streetNumber;//号
