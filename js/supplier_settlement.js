...
function buildTableRow(rowData) {
    ...
    if (statusFlag == 0) {
        ...
        if (bo) {
            ...
            class="btn btn-info btn-sm ml-1 mr-1 mt-1 mb-1 fiCheckToBeConfirmedSupplier" data-toggle="modal" \
        ...
        if (systemBo) {
            ...
            class="btn btn-success btn-sm ml-1 mr-1 mt-1 mb-1 fiCheckSupplierPrepaid" data-toggle="modal" \
    ...
    opt += '<button disabled="disabled" type="button" name="checkTheDetails" id="checkTheDetails" \
                class="btn btn-danger btn-sm ml-1 mr-1 mt-1 mb-1 checkTheSupplierDetails" data-toggle="modal" \
              ...
              <button disabled="disabled" type="button" name="downloadFiCheckDetails" id="downloadFiCheckDetails" \
                class="btn btn-primary btn-sm ml-1 mr-1 mt-1 mb-1 downloadSupplierFiCheckDetails">下载明细</button> \
              </div>';
